...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['update_question'])) {
        ...
        $points = $_POST['points'];
        $correct_answer = $_POST['guided_answer']; 
...
<div class="top-buttons">
    ...
    <div class="container">
        ...
        <img src="images/icons/edit_icon.webp" alt="Edit Icon" class="edit-icon" />
             ...
             <input type="text" id="assessment-name" name="assessment_title" value="<?php echo htmlspecialchars($assessment['name']); ?>" required>
        </div>
        </div>
    </form>
...
<div class="card">
    ...
    <form method="post">
        ...
        <label>Guided Answer for checking (optional):</label>
