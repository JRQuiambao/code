...
try {
    ...
    if ($user_type) {
        ...
        $mail->Body = '
            ...
            <body>
                <p>To reset your password, follow this secure link: <a href="http://localhost/peerquest/reset_password.php?token=' . $token . '" target="_blank">
                <b>here</b></a></p>
                
                <p>Or copy and paste this link into your browser:</p>
                <p><a href="http://localhost/peerquest/reset_password.php?token=' . $token . '" target="_self">
                http://localhost/peerquest/reset_password.php?token=' . $token . '</a></p>

                <p>This email was sent because you requested a password reset. If you did not request this, please ignore it
.</p>
            </body>
            </html>';
