...
<div class="content">
<div class="top-bar">
            <h1 class="dashboard-title">Status for <?php echo htmlspecialchars($student['full_name']); ?> in <?php echo htmlspecialchars($class['class_subject']); ?> - <?php echo htmlspecialchars($class['class_section']); ?></h1>
